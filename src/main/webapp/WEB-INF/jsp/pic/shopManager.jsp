                ...
                <c:if test="${!empty shopPicList }">
                    <c:forEach items="${shopPicList}" var="shop" varStatus="status">
                        <tr style="text-align: center">
                            ...
                            <td>
                                <button type="button" class="btn btn-success" onclick="edit('${shop.id }')">编辑</button>
                                <button type="button" class="btn btn-danger" onclick="del('${shop.id }')">删除</button>
                            </td>
                        </tr>
                    </c:forEach>
                </c:if>
