...
<script>
    ...
    <%--function edit(id) {--%>
        <%--$.ajax({--%>
            <%--url:"<%=basePath%>shop/selectShopById",--%>
            <%--type:"post",--%>
            <%--dataType:"json",--%>
            <%--data:{id:id},--%>
...
<div class="table-responsive">
    <form class="form-inline" role="form" action="<%=basePath%>shoper/selectAll" method="post" id="myform">
        <div style="margin-left: 80px;">
            <%--姓名：<input type="text" name="userName" id="name" value="${shoperInfo1.userName}" class="form-control" style="width: 120px;">--%>
                ...
                <c:if test="${!empty shoperList }">
                    <c:forEach items="${shoperList}" var="shoper">
                        <tr style="text-align: center">
                            <td>${shoper.id}</td>
                            <td>
                                <c:if test="${shoper.shop.shopStatus=='0'}">
                                    <img width=" 50px" height="50px" src="${shoper.shop.path}">
                                </c:if>
                                <c:if test="${shoper.shop.shopStatus=='1'}">
...
<!-- 新增用户模态框（Modal） -->
<form action="<%=basePath%>shop/addShop" enctype="multipart/form-data" method="post" id="register_form1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control required" type="text" id="name1" placeholder="商品名" name="posName" autofocus="autofocus"/>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <i class="fa fa-user fa-lg"></i>
                        用户名： <input class="form-control required" type="text" placeholder="用户名" id="posName" name="userName" autofocus="autofocus"/>
                    </div>
